...
\note{ Bangs force evaluation.}
\note{The computation might diverge.}
\note{Thus the compiler can no longer move the computation around or simplify it.}
\note{Also if the work doesn't have to get done it still might be.}
\note{A little thinking about how the variables are used or looking at core allows us to select which ones we bang selectively.}
\end{frame}
