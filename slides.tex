...
\begin{frame}[fragile]{Performance: Remove \texttt{Maybe} from \texttt{intersect(s)} ($1.32\times$)}
...
\begin{frame}[fragile]{Performance: Hand unroll the fold in intersects ($1.35\times$)}
